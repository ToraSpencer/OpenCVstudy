...
{public:
	...
	std::complex<double> at(int ro,int co);
...
cv::Mat_<double> stepVector(double,double,double);	//用于创建元素间隔相等的行向量。
cv::Mat_<double> stepVector(double,double,int);		//用于创建元素间隔相等的行向量。
...
std::complex<double> cMat::at(int ro,int co)
{
